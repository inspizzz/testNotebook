...
class Experiment:
    ...
    def run(self) -> Dict[str, Any]:
        try:
            ...
            self._phase_baseline_stimulation()
    ...
    def _phase_baseline_stimulation(self) -> None:
        logger.info(
            "Phase: baseline stimulation — electrode %d, %.1f uA, %.0f us, %s, %d trials",
            self.stim_electrode,
        ...
        amplitude_ua = min(abs(self.stim_amplitude_ua), 4.0)
        ...
        logger.info("Baseline stimulation phase complete")
