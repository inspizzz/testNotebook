...
class Experiment:
    ...
    Stimulates electrode 7 at 2 uA / 200 us / PositiveFirst, once every
    2 seconds for 50 repetitions.  All spike events and triggers are
    recorded and persisted via DataSaver.
    """
    ...
    def __init__(
        ...
        # With equal amplitudes, durations must be equal.
        # 2.0 uA * 200 us == 2.0 uA * 200 us  ✓
        self._phase_amplitude1 = amplitude_ua
        self._phase_duration1 = duration_us
        self._phase_amplitude2 = amplitude_ua
        self._phase_duration2 = duration_us
    ...
    def _configure_stimulation(self) -> None:
        """Send stimulation parameters to the Intan software."""
        logger.info(
            "Configuring stimulation: electrode=%d, amplitude=%.2f uA, "
            "duration=%.1f us, polarity=PositiveFirst",
            self.stim_electrode,
            self.amplitude_ua,
            self.duration_us,
        )
        ...
        logger.info("Stimulation parameters sent successfully")

    # ------------------------------------------------------------------
    # Main stimulation loop
    # ------------------------------------------------------------------
    def _run_stimulation_loop(self) -> None:
        """Fire the trigger once every inter_stim_interval_s for num_repetitions."""
        logger.info(
        ...
        for rep in range(self.num_repetitions):
            ...
            logger.info("Repetition %d / %d", rep + 1, self.num_repetitions)
    ...
    def _compile_results(
        ...
        summary: Dict[str, Any] = {
            ...
            "num_repetitions": self.num_repetitions,
            "inter_stim_interval_s": self.inter_stim_interval_s,
            "total_stimulations_fired": len(self._stimulation_log),
        }
